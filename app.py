...
#         # st.write("Columns in the uploaded file:", new_data.columns)
        
#         # Verify that 'Amount' and 'Time' columns are present
#         if 'Amount' in new_data.columns and 'Time' in new_data.columns:
#             frauds = detect_fraud(new_data, isolation_forest)
#             st.write(frauds)
#             fig, ax = plt.subplots()
#             sns.scatterplot(x='PCA1', y='PCA2', hue=frauds.index, palette='coolwarm', ax=ax)
